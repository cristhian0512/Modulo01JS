...
function counter() {
  ...
  // newCounter(); // 1
  // newCounter(); // 2
  var value = 1; // la variable afuera para poder acceder desde afuera con clousure
  return function(){
    return value++; // aumentamos en 1 por cada invocacion
  }
}
//let newCounter = counter(); // lo que retorna = funcion
//newCounter(); // 1
//ewCounter(); // 2
...
function cacheFunction(cb) {
  ...
  // Ejemplo:
  // cb -> function(5) { return 5 * 5; } // 25
  // si invocas la function que retornaste con 5, adentro deberia invocar cb(5) y retornar 25.
  // si la invocas de nuevo con 5, deberia retornar 25 (guardado previament en el cache)
  // Tips, usá un objeto donde cada propiedad sea un argumento, y el valor el resultado.
  // usá hasOwnProperty! devuelvo un booleano (true, false)
  var obj={arg: resulatdo}; //estructura donde se guardan datos = caché
  return function(arg){
...
let textoAsteriscos = crearCadena.bind(this,'*','*'); //siempre retorna una funcion
